...
個人開発の[ハンバーガーレビューアプリ「BurgerStack」](https://burger-stack.com/)(Go + React)を、できるだけ無料で動かしたい。そう思って調べ始めたら候補が多すぎたので、**DB・写真ストレージ・メール・API・フロントの 5 層で 4 つずつ、計 20 サービスに実際にデプロイして比べました**。
