...
const GROUPED = [
  ...
  // Google ログイン(S43 の見た目。ボタン G2・文言 T2「Google で続ける」・置き場所 P3 に決定。サインイン・新規登録は「認証」の画面に統合済み)
  ['Google ログイン', 'google-signin-busy', 'サインイン(Google に移動中)', 'signin.html', 'busy', null, ['ja']],
  ['Google ログイン', 'google-complete-loading', 'Google の手続き(交換中)', 'google-complete.html', 'loading', 'active=none', ['ja']],
  ['Google ログイン', 'google-complete-exists', 'Google の失敗(同じメールのアカウントがある)', 'google-complete.html', 'exists', 'active=none'],
  ['Google ログイン', 'google-complete-exists-oauth', 'Google の失敗(同じメールのアカウントがある・元の画面へ戻れる)', 'google-complete.html', 'exists-oauth', 'active=none', ['ja']],
  ['Google ログイン', 'google-complete-taken', 'Google の失敗(ほかのアカウントに連携済み)', 'google-complete.html', 'taken', 'active=none', ['ja']],
  ['Google ログイン', 'google-complete-failed', 'Google の失敗(失敗・キャンセル)', 'google-complete.html', 'failed', 'active=none'],
  ['Google ログイン', 'google-complete-expired', 'Google の失敗(リンクが無効・期限切れ)', 'google-complete.html', 'expired', 'active=none', ['ja']],
  ['Google ログイン', 'google-complete-linkfail', '連携の失敗(すでに別の Google を連携している)', 'google-complete.html', 'linkfail', 'auth=in&active=me', ['ja']],
  ['Google ログイン', 'google-complete-linktaken', '連携の失敗(この Google はほかのアカウントに連携済み)', 'google-complete.html', 'linktaken', 'auth=in&active=me', ['ja']],
  ['Google ログイン', 'google-complete-linkerror', '連携の失敗(そのほかのエラー)', 'google-complete.html', 'linkerror', 'auth=in&active=me', ['ja']],
  ['Google ログイン', 'google-complete-linkexpired', '連携の失敗(リンクが無効・期限切れ)', 'google-complete.html', 'linkexpired', 'auth=in&active=me', ['ja']],
  ['Google ログイン', 'google-profile-none', 'プロフィールの Google 欄(未連携)', 'google-profile.html', 'none', 'active=me'],
  ['Google ログイン', 'google-profile-connected', 'プロフィールの Google 欄(連携済み)', 'google-profile.html', 'connected', 'active=me'],
  ['Google ログイン', 'google-profile-cannot', 'プロフィールの Google 欄(解除できない)', 'google-profile.html', 'cannot', 'active=me', ['ja']],
  ['Google ログイン', 'google-profile-loaderror', 'プロフィールの Google 欄(読み込み失敗)', 'google-profile.html', 'loaderror', 'active=me', ['ja']],
  ['Google ログイン', 'google-profile-states', 'プロフィールの Google 連携の状態(操作の途中と結果)', 'google-profile-states.html', 'default', 'active=me', ['ja']],
