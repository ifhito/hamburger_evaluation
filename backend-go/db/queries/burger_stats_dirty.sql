-- name: MarkBurgerStatsDirty :exec
...
-- name: ListDueBurgerStatsDirty :many
...
-- name: DeleteBurgerStatsDirtyIfVersion :execrows
...
-- name: RecordBurgerStatsDirtyFailure :execrows
