...
type fakeReviewRepo struct {
	...
	createReviewForNamedBurger func(ctx context.Context, shopID string, burgerName string, review domain.Review) (domain.Review, domain.ShopReviewBurger, error)
...
func (f *fakeReviewRepo) CreateReviewForNamedBurger(ctx context.Context, shopID string, burgerName string, review domain.Review) (domain.Review, domain.ShopReviewBurger, error) {
...
func TestReviewsCreate(t *testing.T) {
	...
	t.Run("burger_name 経由では repository 越しに find-or-create し payload を組み立てる", func(t *testing.T) {
		...
		repo := &fakeReviewRepo{
			createReviewForNamedBurger: func(_ context.Context, shopID string, burgerName string, review domain.Review) (domain.Review, domain.ShopReviewBurger, error) {
