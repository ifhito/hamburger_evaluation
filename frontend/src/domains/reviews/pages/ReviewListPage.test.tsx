...
const state = vi.hoisted(() => ({
  ...
  reviews: [] as { id: string; rating: number; comment: string; photoUrl: string | null; createdAt: string; user: { id: string; username: string } | null; burger: null }[],
}));
...
beforeEach(() => {
  state.authUser = null;
  state.reviews = [{ id: "1", rating: 5, comment: "Great", photoUrl: null, createdAt: "2026-09-21T00:00:00Z", user: { id: "2", username: "alice" }, burger: null }];
});
afterEach(cleanup);
