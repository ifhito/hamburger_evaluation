const en = {
  mcp: {
    ...
    "setupStatus": "Configuration example (new regular-account connection not yet verified)",
    ...
    "setupVersion": "Options were checked against Codex CLI 0.156.1 help. Older versions may need an update.",
    "official": "Official Codex MCP guide",
    "statusTitle": "App verification status",
    "checkedOn": "Checked: September 26, 2026",
    "app": "App",
    "status": "Status",
    "codexStatus": "Partially verified: metadata and shop search worked with the operator’s existing connection. New connections, regular users, posting, and revocation have not been verified.",
    "unverified": "Unverified: a successful connection to this service has not been confirmed.",
    "unsupportedName": "Apps supporting only DCR",
    "unsupported": "Unsupported: Dynamic Client Registration (DCR) is unavailable. CIMD support or registration by the operator is required.",
    "disconnectTitle": "Disconnect an app",
    "disconnect": "Sign in to Burger Stack, open your profile, choose “Edit profile”, and find “Connected apps”. Disconnect the app there. To use it again, authorize a new connection.",
    "signin": "Sign in",
