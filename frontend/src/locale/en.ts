const en = {
  ...
  about: {
    ...
    tagline: "Good burgers.\nLasting memories.",
    lead: "Remember the burgers you have tried.\nFind the one you want to try next.",
    messageTitle: "Some bites stay with you.",
    messageFirst: "The sear on the patty. The texture of the bun. The time spent at the shop. There is more to a great burger than a score can capture.",
    messageSecond: "The reason you want to go back, or a discovery at a shop you wandered into: a photo and a few words can bring that bite back to you. We want BurgerStack to be a place where those delicious memories add up.",
    messageLast: "Your favorite could become\nsomeone else’s next stop.",
    valuesTitle: "What matters to us",
    recordTitle: "Remember what you love.",
    recordBody: "A rich patty, an unexpected sauce, a burger you keep coming back to. We all notice different things. Keep your impressions in a review, with a photo and the date you ate it, and build a record that is yours.",
    discoverTitle: "Find your next bite.",
    discoverBody: "There may be a burger you have not discovered in your own neighborhood or on your next trip. Browse shops, burgers, and reviews to find something that makes you look forward to going out.",
    shareTitle: "Build memories together.",
    shareBody: "One person’s memory can make someone else want to try a burger. Different shops, different tastes, different ways to enjoy them: we want to build a place where those discoveries come together.",
    inviteTitle: "There is room for your story.",
    inviteBody: "Start by finding a shop that interests you. After your visit, sign in and leave a review from the shop page. Even a few words can inspire someone’s next delicious discovery.",
    start: "Explore shops",
